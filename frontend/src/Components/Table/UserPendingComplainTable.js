...
import { getUserComplain, solvedComplain } from "../../store/complain/action";
...
const UserPendingComplainTable = (props) => {
  ...
  useEffect(() => {
    props.getUserComplain("pending", id);
  }, []);
