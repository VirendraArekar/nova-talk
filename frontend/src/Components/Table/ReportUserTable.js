...
const ReportUserTable = (props) => {
  ...
  useEffect(() => {
    props.getReportedUser(agencyId);
    props.getAgency();
  }, []);
  useEffect(() => {
    props.getReportedUser(agencyId);
  ...
  const handleSearch = (e) => {
    ...
    if (value) {
      const data = reportUser.filter((data) => {
        return (
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                <div class="row">
                  <div class="col-xs-12 col-sm-12 col-md-6 col-lg-5 mt-4 float-left">
                    <h3 class="card-title">User Report</h3>
                  </div>
                  <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 mt-4 float-right">
                    <select
...
export default connect(null, { getReportedUser, getAgency })(ReportUserTable);
