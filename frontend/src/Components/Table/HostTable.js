...
const HostTable = (props) => {
  ...
  const setExtraBonus = (data) => {
    if (!hasPermission) return permissionError();
    props.extraBonus(data._id);
  };
                          ...
                          {(rowsPerPage > 0
                            ...
                            return (
                              <tr key={index}>
                                ...
                                <td style={{ verticalAlign: "middle" }}>
                                  {data.isLive ? <span className="text-success font-weight-bold">
                                    Live
                                  </span> : data.isOnline ? (
                                ...
                                >
                                  <label class="switch">
                                    <input
                                      type="checkbox"
                                      checked={data.bonusSwitch}
                                      onChange={() => setExtraBonus(data)}
                                    />
                                    <span class="slider">
                                      <p
                                        style={{
                                          fontSize: 12,
                                          marginLeft: `${data.bonusSwitch ? "-25px" : "25px"
                                            }`,
                                          color: "white",
                                          marginTop: "6px",
                                        }}
                                      >
                                        {data.bonusSwitch ? "Yes" : "No"}
                                      </p>
                                    </span>
                                  </label>
                                </td>
...
export default connect(null, { getHost, blockUnblockHost, extraBonus })(
  HostTable
);
