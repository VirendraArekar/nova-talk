...
import { getAgencyPendingRedeem } from "../../store/redeem/action";
...
const AgencyPendingRedeemTable = (props) => {
  const [data, setData] = useState([]);

  const [page, setPage] = useState(0);
  const [rowsPerPage, setRowsPerPage] = useState(5);

  const redeem = useSelector((state) => state.redeem.agencyPendingRedeem);
                          ...
                          {(rowsPerPage > 0
                            ...
                            return (
                              <tr key={index}>
                                ...
                                <td style={{ verticalAlign: "middle" }}>
                                  <Link to={"/admin/redeem/agency/" + data._id}>
                                    <button
                                      type="button"
...
export default connect(null, {
  getAgencyPendingRedeem,
})(AgencyPendingRedeemTable);
